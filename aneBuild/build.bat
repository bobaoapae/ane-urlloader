...
dotnet publish /p:NativeLib=Shared /p:Configuration=Release ..\windowsCSharpLibrary\UrlLoaderNativeLibrary\UrlLoaderNativeLibrary.csproj
dotnet publish -c Release -r osx-x64 -p:NativeLib=Shared ..\windowsCSharpLibrary\UrlLoaderNativeLibrary\UrlLoaderNativeLibrary.csproj --self-contained
dotnet publish -c Release -r osx-arm64 -p:NativeLib=Shared ..\windowsCSharpLibrary\UrlLoaderNativeLibrary\UrlLoaderNativeLibrary.csproj --self-contained
xcopy ..\windowsCSharpLibrary\UrlLoaderNativeLibrary\bin\Release\net9.0\win-x86\publish\UrlLoaderNativeLibrary.dll .\windows-32\UrlLoaderNativeLibrary.dll /Y /F
